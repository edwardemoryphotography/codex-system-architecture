...
export const CORPUS_DOCUMENTS: CorpusDocument[] = [
  ...
  { title: 'CDAAO', path: '/codex/council/roles/cdaao.md', content: 'Chief Data and AI Architecture Officer', category: 'council', parentPath: '/codex/council/roles', order: 3 },
  { title: 'Creative Agent', path: '/codex/council/roles/creative_agent.md', content: 'Creative and artistic role', category: 'council', parentPath: '/codex/council/roles', order: 4 },
  { title: 'Chairman', path: '/codex/council/roles/chairman.md', content: 'Leadership and oversight role', category: 'council', parentPath: '/codex/council/roles', order: 5 },
  ...
  { title: 'Firefall 2026', path: '/codex/artistic_systems/photography_ops/firefall_2026.md', content: 'Firefall project 2026', category: 'artistic_systems', parentPath: '/codex/artistic_systems/photography_ops', order: 4 },
  { title: 'Namibia 2026', path: '/codex/artistic_systems/photography_ops/namibia_2026.md', content: 'Namibia expedition 2026', category: 'artistic_systems', parentPath: '/codex/artistic_systems/photography_ops', order: 5 },
  ...
  { title: '6 Figure Print Engine', path: '/codex/artistic_systems/artful_intelligence/6_figure_print_engine.md', content: 'Print monetization engine', category: 'artistic_systems', parentPath: '/codex/artistic_systems/artful_intelligence', order: 3 },
  ...
  { title: 'PWA iPhone16', path: '/codex/artistic_systems/artful_intelligence/pwa_iphone16.md', content: 'Progressive web app for iPhone 16', category: 'artistic_systems', parentPath: '/codex/artistic_systems/artful_intelligence', order: 5 },
  ...
  { title: 'Adaptive ML Models', path: '/codex/neuro/adaptive_ml_models.md', content: 'Machine learning models for adaptation', category: 'neuro', parentPath: '/codex/neuro', order: 2 },
  { title: 'Whoop Integration', path: '/codex/neuro/whoop_integration.md', content: 'Whoop fitness tracking integration', category: 'neuro', parentPath: '/codex/neuro', order: 3 },
  { title: 'Bio Geometry Engine', path: '/codex/neuro/bio_geometry_engine.md', content: 'Biometric geometry and spatial analysis', category: 'neuro', parentPath: '/codex/neuro', order: 4 },
  ...
  { title: 'Neurodivergent OS', path: '/codex/personal_os/neurodivergent_os.md', content: 'Neurodivergent optimization framework', category: 'personal_os', parentPath: '/codex/personal_os', order: 1 },
  ...
  { title: 'Convergence Log v16', path: '/codex/convergence/convergence_log_v16.md', content: 'Integration log version 16', category: 'convergence', parentPath: '/codex/convergence', order: 0 },
